							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form class="user" method="post"
										action="http://localhost:8080/WebProject/AdminLogin?action=loginfromadmin">
										...
										<hr>
										<a href="http://localhost:8080/WebProject/admin/index.jsp"
											class="btn btn-google btn-user btn-block"> <i
											class="fab fa-google fa-fw"></i> Đăng nhập với Google
										</a> <a href="http://localhost:8080/WebProject/admin/index.jsp"
											class="btn btn-facebook btn-user btn-block"> <i
											class="fab fa-facebook-f fa-fw"></i> Đăng nhập với Facebook
										</a>
									</form>
									<hr>
									<div class="text-center">
										<a class="small"
											href="http://localhost:8080/WebProject/admin/forgot-password.jsp">Quên
											mật khẩu </a>
									</div>
									<div class="text-center">
										<a class="small"
											href="http://localhost:8080/WebProject/admin/register.jsp">Đăng
											ký tài khoản admin mới!</a>
									</div>
								</div>
							</div>
						</div>
