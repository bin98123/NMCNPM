...
<c:set var="sanpham" value="${requestScope['sanpham']}"></c:set>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
				...
				<div class="card-body">
					<div>
						<span style="padding-right: 84px;">Mã mặt hàng:</span> <input
							type="text" style="width: 600px; padding: 3px" name="productName" value="${ sanpham.getMaMH()}" disabled="disabled"
							required="required">
					</div>
					<hr>
					<div>
						<span style="padding-right: 80px;">Tên Mặt hàng:</span> <input
							type="text" style="width: 600px; padding: 3px" name="productType" value="${sanpham.getTenMH() }"
							required="required">
					</div>
					<hr>
					<div>
						<span style="padding-right: 130px;">giá Mua:</span> <input
							type="text" style="width: 600px; padding: 3px" name="thuocnhom" value="${sanpham.getGiaMua() }"
							required="required">
					</div>
					<hr>
					<div>
						<span style="padding-right: 130px;">Giá bán:</span> <input type="text" value="${sanpham.getGiaBan() }"
							name="productPrice" style="width: 600px; padding: 3px"
							required="required">
					</div>
					<hr>
					<div>
						<span style="padding-right: 80px;">số lượng nhập:</span> <input
							type="text" style="width: 600px; padding: 3px" name="tonkho" value="${sanpham.getSlNhap() }"
							required="required">
					</div>
				</div>
			</div>
			...
			<div class="card shadow mb-4" style="width: 205%">
				...
				<div>
						<span style="padding-right: 125px;">Số lượng bán:</span> <input
							type="text" style="width: 600px; padding: 3px" name="description" value="${sanpham.getSlBan() }"
							required="required">
					</div>
					<hr>
					<div>
						<span style="padding-right: 125px;">Mã Loai Hàng:</span> <input
							type="text" style="width: 600px; padding: 3px" name="malh" value="${sanpham.getLoaihang().getMaLh() }"
							required="required" disabled="disabled">
					</div>
					<hr>
					<div>
						<span style="padding-right: 125px;">Mã Đơn Vị Tính:</span> <input
							type="text" style="width: 600px; padding: 3px" name="madvt" value="${sanpham.getDvt().getMaDvt() }"
							required="required" disabled="disabled">
					</div>
				</div>
